#include "userdoublesetting.h".h"

UserDoubleSetting::UserDoubleSetting(QWidget *parent) : QWidget(parent)
{
    ...
    connect(startButton, &QPushButton::clicked, this, &UserDoubleSetting::startNewDoubleGame);
}

void UserDoubleSetting::startNewDoubleGame()
{
    newDoublegame = new DoubleGame(input_rows->value(), input_columns->value(), input_timeLimit->value());
    newDoublegame->show();
    close();
}
